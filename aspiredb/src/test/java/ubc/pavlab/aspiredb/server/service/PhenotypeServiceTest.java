...
public class PhenotypeServiceTest extends BaseSpringContextTest {
        ...
        new InlineTransaction() {
            ...
            public void instructions() {
                ...
                subject1 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest(
                        RandomStringUtils.randomAlphabetic( 5 ), "Abnormality of abnormalities", "uri1", "1" );
                subject2 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest(
                        RandomStringUtils.randomAlphabetic( 5 ), "Abnormality of abnormalities", "uri1", "0" );
                subject3 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest(
                        RandomStringUtils.randomAlphabetic( 5 ), "Abnormality of abnormalities", "uri1", "1" );
                subject4 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest(
                        RandomStringUtils.randomAlphabetic( 5 ), "Abnormality of abnormalities", "uri1", "0" );
                subject5 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest(
                        RandomStringUtils.randomAlphabetic( 5 ), "Abnormality of abnormalities", "uri1", "0" );
                subject6 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest(
                        RandomStringUtils.randomAlphabetic( 5 ), "Abnormality of abnormalities", "uri1", "1" );
                subject7 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest(
                        RandomStringUtils.randomAlphabetic( 5 ), "Abnormality of abnormalities", "uri1", "1" );
                subject8 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest(
                        RandomStringUtils.randomAlphabetic( 5 ), "Abnormality of abnormalities", "uri1", "1" );
                subject9 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest(
                        RandomStringUtils.randomAlphabetic( 5 ), "Abnormality of abnormalities", "uri1", "1" );

                subjectNoPhenotypes = testObjectHelper.createPersistentTestIndividualObject( RandomStringUtils
                        .randomAlphabetic( 5 ) );
    ...
    public void testGetPhenotypeEnrichment() throws Exception {
        ...
        List<PhenotypeEnrichmentValueObject> pevoList = phenotypeService.getPhenotypeEnrichmentValueObjects(
                projectIdList, subjectIdList );
         ...
         * @param lowerTail
         * 
         * @return cumulative hypergeometric distribution. public static double phyper( int x, int NR, int NB, int n,
         * boolean lowerTail )
         */
