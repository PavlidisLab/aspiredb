...
public class PhenotypeDaoTest extends BaseSpringContextTest {
    ...
    public void setup() throws NotLoggedInException {
        new InlineTransaction() {
            ...
            public void instructions() {
                ...
                subject1 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest( patientId,"Abnormality of abnormalities", "uri1","1" );
                subject2 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest( patientId2,"Abnormality of breakfast cereal", "uri2","0" );
                subject3 = testObjectHelper.createPersistentTestSubjectObjectWithHPOntologyPhenotypesForEnrichmentTest( patientId3,"Abnormality of cow", "uri3","1" );
    ...
    public void testfindByProjectIdsAndUri() throws Exception {        
        ...
        Collection<Phenotype> phenotypes2 = phenotypeDao.findPresentByProjectIdsAndUri( activeProjects2,"uri2"  );
