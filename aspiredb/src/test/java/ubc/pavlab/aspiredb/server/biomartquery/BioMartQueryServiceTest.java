...
public class BioMartQueryServiceTest extends BaseSpringContextTest {
    ...
    /**
     * More of integration test (actually calls BioMart). We check that we get some results (i.e. not an empty list).
     * 
     * @throws BioMartServiceException
     */
    @Test
    public void testFetchGenesByGenomicLocation() throws BioMartServiceException {
        Collection<GeneValueObject> geneValueObjects = this.bioMartQueryService.fetchGenesByLocation( "7", 140000000L,
                141000000L );
