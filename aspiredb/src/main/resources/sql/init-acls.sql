...
insert into acl_class (id, class) values(1, "ubc.pavlab.aspiredb.server.model.common.auditAndSecurity.User");
insert into acl_class (id, class) values(2, "ubc.pavlab.aspiredb.server.model.common.auditAndSecurity.UserGroup");
...
insert into acl_sid (id, principal, sid) values(6, 1, "aspiredbAgent");
insert into acl_sid (id, principal, sid) values(7, 1, "user");
...
-- Add object identity (OI) for the user user. There is no parent object, the owner = the administrator; non-inheriting.
insert into acl_object_identity (id, object_id_class, object_id_identity, parent_object, owner_sid, entries_inheriting) values (6, 1, 3, null, 1, 0);

-- Add object identity (OI) for the nonuser user. There is no parent object, the owner = the administrator; non-inheriting.
insert into acl_object_identity (id, object_id_class, object_id_identity, parent_object, owner_sid, entries_inheriting) values (7, 1, 4, null, 1, 0);
