...
@Service("projectServiceOld")
public class ProjectServiceOldImpl extends GwtService implements ProjectServiceOld {

    private static Logger log = LoggerFactory.getLogger( ProjectServiceOldImpl.class );
    ...
    public List<ProjectValueObjectOld> getProjects() throws NotLoggedInException {
        ...
        List<ProjectValueObjectOld> vos = new ArrayList<ProjectValueObjectOld>();
