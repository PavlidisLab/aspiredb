 ...
 */
package ubc.pavlab.aspiredb.server.listener;
...
/**
 * Created by mjacobson on 15/11/17.
 */
public class StartupListener extends ContextLoaderListener {
    ...
    private Map<String, Object> initializeConfiguration( ServletContext context ) {
        ...
        for ( Iterator<String> it = ConfigUtils.getKeys(); it.hasNext(); ) {
            String o = it.next();
            config.put( o, ConfigUtils.getProperty( o ) );
        }
