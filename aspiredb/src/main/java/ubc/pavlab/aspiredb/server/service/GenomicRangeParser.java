...
public class GenomicRangeParser {
    ...
    public static class ParseResult {
        ...
        public boolean isBase() {
            return isValid && getMatchedGroupByIndices( START_BASE_INDICES ) != null
                    && getMatchedGroupByIndices( END_BASE_INDICES ) != null;
        }
    ...
    public static ParseResult parse( String query ) {
        ...
        if ( matchResult == null ) {
            ...
            } else if ( ( matchResult.getGroup( 12 ) != null && ( queryInLowerCase.endsWith( "-" )
                    || queryInLowerCase.endsWith( "p" ) || queryInLowerCase.endsWith( "q" ) ) )
                    || matchResult.getGroup( 2 ) != null ) {
                state = State.END_RANGE;
            } else if ( ( matchResult.getGroup( 15 ) != null && ( queryInLowerCase.endsWith( "p" ) || queryInLowerCase
                    .endsWith( "q" ) ) ) || matchResult.getGroup( 12 ) != null ) {
