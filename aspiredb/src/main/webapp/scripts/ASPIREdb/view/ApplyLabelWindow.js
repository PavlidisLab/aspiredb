...
/**
 * UI for applying existing labels to Subject(s) and Variant(s)
 */
Ext.define( 'ASPIREdb.view.ApplyLabelWindow', {
   /**
    * @memberOf ASPIREdb.view.ApplyLabelWindow
    */
   extend : 'Ext.Window',
   alias : 'widget.applyLabelWindow',
   title : 'Apply label',
   closable : true,
   modal : true,
   closeAction : 'destroy',
   ...
   createItems : function(vos, me) {
      ...
      labelCombo.on( 'change', function(combo, record) {console.log(this, combo, record)}, this );
