 ...
 * groupField: 'department', data: {'employees':[ { "name": "Michael Scott", "seniority": 7, "department": "Management" }, {
 * "name": "Dwight Schrute", "seniority": 2, "department": "Sales" }, { "name": "Jim Halpert", "seniority": 3,
 * "department": "Sales" }, { "name": "Kevin Malone", "seniority": 4, "department": "Accounting" }, { "name": "Angela
 * Martin", "seniority": 5, "department": "Accounting" } ]}, proxy: { type: 'memory', reader: { type: 'json', root:
 * 'employees' } } });
 */
      ...
      for (var j = 0; j < selPhenotypes.length; j++) {
         ...
         for ( var key in phenSummary.phenoSummaryMap) {
            ...
            if ( key == "Present" || key == "Y" )
               ...
               subjects = phenSummary.subjects[key];
