...
var ChromosomeLayer = function(name, baseSize, centromerePosition, topY, leftX, displayScaleFactor, ctx, bands, zoom) {
   ...
   /*
    * int displaySize; int shortArmDisplaySize; int longArmDisplaySize; int displayWidth; int centromereDisplaySize; int
    * baseSize; int centromerePosition; // to tell short arm and long arm apart
    */
