...
Ext.define('ASPIREdb.view.filter.DgvProjectOverlapFilterContainer', {
	...
	initComponent : function() {
		...
		//keeping this here but hidden so that the dwr object gets constructed properly(with an empty phenotypeRestriction		
		filterContainer.insert(0, {xtype: 'filter_phenotype_property', itemId : 'phenRestriction', hidden :true });
		filterContainer.insert(0, {
			xtype : 'label',
