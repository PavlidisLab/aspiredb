...
Ext.require( [ 'ASPIREdb.store.PhenotypeStore', 'ASPIREdb.ActiveProjectSettings',
              ...
              'ASPIREdb.view.PhenotypeContigencyTableWindow', 'ASPIREdb.view.PhenotypeSubjectLabelWindow' ] );
...
Ext.define( 'ASPIREdb.view.PhenotypeGrid',
   {
      ...
      columns : [
...

                 {
                    ...
                    renderer : function(value) {
                       ...
                       /**
                         * Used the Color Brewer 2.0 system for coloring the chart Thanks for Cynthia Brewer, Mark
      ...
      initComponent : function() {
         ...
         this.getDockedComponent( 'phenotypeGridToolbar' ).getComponent( 'heatmapButton' ).on( 'click',
            this.viewHeatmap, this );
